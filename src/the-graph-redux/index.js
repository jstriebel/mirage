...
export class ReduxJournal extends TheGraph.fbpGraph.Journal {
  endTransaction(id, meta) {
    ...
    this.appendCommand('endTransaction', {id: id, metadata: meta}, this.currentRevision)
    ...
    this.currentRevision = this.store.putTransaction(this.currentRevision, this.entries)
    this.entries = []
  }
}
